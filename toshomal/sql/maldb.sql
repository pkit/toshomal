create table show (
	id_show integer not null primary key generated always as identity,
	name varchar(150),
	malid integer,
	status varchar(20),
	type_show char(10),
...
create table eps (
	id_eps integer not null primary key generated always as identity,
...
create table file (
	id_file integer not null primary key generated always as identity,
	time timestamp,
	name varchar (256),
	url varchar (512),
	ext char (3),
...
create table tag (
	id_tag integer not null primary key generated always as identity,
	name varchar (50),
	type_tag integer
);
